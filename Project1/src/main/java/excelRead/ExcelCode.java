...
public class ExcelCode {
	...
	static FileInputStream f; // to open the excel file 
	static XSSFWorkbook w; // to read the excel file
	static XSSFSheet sh; // to select the specific sheet

	public static String readStringData(int row, int col) throws IOException {
		f = new FileInputStream("C:\\Users\\manuk\\Downloads\\Book.xlsx");
